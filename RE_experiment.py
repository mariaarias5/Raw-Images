...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Master\\4th Semester\\Master thesis\\Psy\\Raw Images\\untitled_lastrun.py',
...
key_resp.rt = []
_key_resp_allKeys = []
text.setText('Welcome  press SPACEBAR to continue')
# keep track of which components have finished
WelcomeScreenComponents = [key_resp, text]
...
for thisTrial_2 in trials_2:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    image2.setImage('ImageStimuli.xlsx')
    # setup some python lists for storing info about the mouse
    gotValidClick = False  # until a click is received
    # keep track of which components have finished
    imageComponents = [image2, mouse]
    ...
    for thisComponent in imageComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_2.addData('image2.started', image2.tStartRefresh)
    trials_2.addData('image2.stopped', image2.tStopRefresh)
